...
public class SocketClientThread extends Thread
{
    ...
    private void openSocket() throws IOException
    {
        ...
        catch (IOException e)
        {
            ...
            Message msg = ControlActivity.handler.obtainMessage(ControlActivity.CONNECTION_ERROR, e.getMessage());
            ControlActivity.handler.sendMessage(msg);
            throw e;
        }
    }
    ...
    private void robotCommand()
    {
        ...
        catch (IOException e)
        {
            ...
            // Send error message to UI
            Message msg = ControlActivity.handler.obtainMessage(ControlActivity.CONNECTION_LOST, e.getMessage());
            ControlActivity.handler.sendMessage(msg);
            socket = null;
        }

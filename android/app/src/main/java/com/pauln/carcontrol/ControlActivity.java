...
import static com.pauln.carcontrol.RobotCommand.Stop;

/**
 * ArmControl activity.
 * Written by Dr Paul Netherwood
 */
public class ControlActivity extends ActionBarActivity implements ButtonDispatcherInterface
{
    /**
     * Main socket thread
     */
    ...
    protected void onStart()
    {
        ...
        final String stream = sharedPref.getString(ControlSettingsActivity.STREAM_KEY, "http://172.16.5.206:8080/stream");
    ...
    private void startSocketClient()
    {
        ...
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(this);
        String host = sharedPref.getString(ControlSettingsActivity.HOST_KEY, "172.16.5.206");
        String port = sharedPref.getString(ControlSettingsActivity.PORT_KEY, "5000");
    ...
    {
        socketClientThread.sendCommand(new ButtonCommand(Stop));
        Log.i("RobotCommand", "Stopped");
    }
